...
public class EchoClientUI implements ActionListener{
	...
	public EchoClientUI(String id, String ip, int port) {
		...
		JScrollPane jsp = new JScrollPane(
				jta,		//가로는 스크롤바 없고, 세로는 스크롤바 생성
				JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
				JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
		//jta.setBackground(new Color(135,110,180));
		/********************중앙 끝**********************/
		/********************하단시작*********************/
		...
		j2.setBackground(new Color(100,80,130));
		/*******************상단 끝***********************/
		/**********************************************/
	...
	public static void main(String[] args) {
		...
		new EchoClientUI("hello","192.168.0.28",3000).connect();
	}
	@Override
